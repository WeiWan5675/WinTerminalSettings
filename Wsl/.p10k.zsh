...
#  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%244F─╯'
  ...
  ##################################[ dir ]##################################
  typeset -g POWERLEVEL9K_DIR_DEFAULT_BACKGROUND=105
  typeset -g POWERLEVEL9K_DIR_DEFAULT_FOREGROUND=0
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=105
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=0
  
  typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_BACKGROUND=009
  typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_FOREGROUND=0
  typeset -g POWERLEVEL9K_DIR_ETC_BACKGROUND=202
  typeset -g POWERLEVEL9K_DIR_ETC_FOREGROUND=0
  typeset -g POWERLEVEL9K_DIR_HOME_BACKGROUND=200
  typeset -g POWERLEVEL9K_DIR_HOME_FOREGROUND=0
  typeset -g POWERLEVEL9K_DIR_HOME_SUBFOLDER_BACKGROUND=200
  ...
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=093

  #####################################[ swap ]######################################
  typeset -g POWERLEVEL9K_SWAP_FOREGROUND=0
  typeset -g POWERLEVEL9K_SWAP_BACKGROUND=099

  ######################################[ load ]######################################
  typeset -g POWERLEVEL9K_LOAD_WHICH=1
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=0
  typeset -g POWERLEVEL9K_LOAD_NORMAL_BACKGROUND=135
  ...
  typeset -g POWERLEVEL9K_PUBLIC_IP_BACKGROUND=47
  ...
  typeset -g POWERLEVEL9K_USER_BACKGROUND=214
  #####################################[ host ]#####################################
  typeset -g POWERLEVEL9K_HOST_FOREGROUND=0
  typeset -g POWERLEVEL9K_HOST_BACKGROUND=056
  ...
  function p10k-on-post-prompt() {
		p10k display '1/left/(ip|wifi|ram|swap|load|host)'=hide
	}
  function p10k-on-pre-prompt()  { 
		p10k display '1/left/(ip|wifi|ram|swap|load|host)'=show
	}
